...
<meta name="theme-color" content="#1e2327">
  ...
  <div class="position-relative js-header-wrapper ">
    <a href="src/assets/js/vendor/html5shiv#start-of-content" tabindex="1" class="accessibility-aid js-skip-to-content">Skip to content</a>
  ...
  <div class="container-responsive">
    <a class="header-logo-invertocat" href="src/assets/js/vendor/html5shiv" aria-label="Homepage" data-ga-click="(Logged out) Header, go to homepage, icon:logo-wordmark">
        ...
        <div class="select-menu-tabs">
          <ul>
            <li class="select-menu-tab">
              <a href="src/assets/js/vendor/html5shiv#" data-tab-filter="branches" data-filter-placeholder="Filter branches/tags" class="js-select-menu-tab" role="tab">Branches</a>
            </li>
            <li class="select-menu-tab">
              <a href="src/assets/js/vendor/html5shiv#" data-tab-filter="tags" data-filter-placeholder="Find a tag…" class="js-select-menu-tab" role="tab">Tags</a>
            </li>
          </ul>
        </div>
      </div>
